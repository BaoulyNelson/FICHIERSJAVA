...
public class FenetreOngletJava extends Stage {
    ...
    TableView<Produit> tbv = new TableView<>();
    ...
    void tableView() {
        ...
        TableColumn<Produit, String> colDesc = new TableColumn<>("Desciption");
        TableColumn<Produit, String> colPrix = new TableColumn<>("Prix");
        TableColumn<Produit, String> colQte = new TableColumn<>("Quantite");
